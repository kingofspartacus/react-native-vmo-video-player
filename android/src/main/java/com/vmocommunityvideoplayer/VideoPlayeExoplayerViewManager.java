...
public class VideoPlayeExoplayerViewManager extends ViewGroupManager<ReactExoplayerView> {
    ...
    public VideoPlayeExoplayerViewManager(ReactExoplayerConfig config) {
        this.config = config;
    }
